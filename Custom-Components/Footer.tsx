    ...
    <footer className="w-full border-t bg-background pt-6 text-muted-foreground">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:grid-cols-2 lg:grid-cols-3 lg:px-8">
        ...
        <aside className="hidden space-y-4 lg:flex lg:flex-col">
          ...
          <p className="text-sm leading-relaxed lg:mt-[-10] lg:ml-13.5">
            {info?.slogan}
          </p>
        </aside>
        ...
        {/* Links Section */}
        <nav className="">
          <h6 className="text-lg font-bold tracking-wide text-foreground uppercase">
            অন্যান্য লিংক সমূহ
          </h6>
      ...
      <div className="mt-8 border-t border-border px-4 py-6 text-center text-sm sm:px-6 lg:px-8">
        ...
        <p className="mt-1">
          Developed by:{" "}
          <span className="font-medium text-primary">Opi Rajbhor</span>
        </p>
      </div>
    </footer>
  )
